...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: songml-validate <file.songml>")
        sys.exit(1)
    ...
    try:
        ...
        print(f"✓ Parsed successfully: {len(doc.items)} top-level items")
        ...
        print(f"\nSummary: {section_count} sections, {property_count} properties")
