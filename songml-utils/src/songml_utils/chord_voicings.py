...
type VoicingEntry = tuple[str, list[int], str, int]
type VoicingTable = dict[str, VoicingEntry]
    ...
    with open(tsv_path, encoding="utf-8") as f:
        for line_num, line in enumerate(f, start=1):
            ...
            try:
                ...
                raise ValueError(f'Line {line_num}: Invalid offsets "{offsets_str}": {e}') from e
