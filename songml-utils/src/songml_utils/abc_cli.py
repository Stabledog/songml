...
from .abc_exporter import export_abc
...
def main() -> None:
    ...
    parser.add_argument('output', metavar='OUTPUT',
                        help='output ABC file (use "-" for stdout)')
    parser.add_argument('--unit-length', metavar='L',
                        help='override computed unit note length (e.g., "1/16")')
    parser.add_argument('--chord-style', metavar='STYLE',
                        default='chordline',
